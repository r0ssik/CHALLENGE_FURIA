...
def generate_ai_response(message):
    try:
        prompt = (
            "Você é um especialista no time FURIA Esports e também um torcedor da furia lembre de usar as hashtags caracteristicas da marca como #DIADEFURIA e outras. "
...
def refine_response_with_ai(pergunta, resposta_gerada):
    try:
        prompt = (
            "Você é um especialista em FURIA Esports também um torcedor da furia(lembre de usar as hashtags caracteristicas da marca como #DIADEFURIA e outras.) e seu trabalho é melhorar a coerência entre perguntas e respostas. "
